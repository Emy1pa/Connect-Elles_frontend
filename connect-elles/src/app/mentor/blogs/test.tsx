...
const BlogsList = () => {
  ...
  const handleEdit = (blog: Blog) => {
    ...
    setValue("categoryId", blog.category?._id || "");
    setPreviewImage(
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input
                  type="text"
                  {...register("title")}
                  className="w-full px-4 py-3 rounded-xl border border-teal-200 focus:border-teal-400 focus:ring-teal-400 focus:ring-2 focus:outline-none transition-all duration-300 bg-white/90"
                />
                {errors.title && (
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-teal-400 to-teal-600 text-white rounded-xl font-medium shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2"
              >
                {editingBlog ? (
                  <>Edit Blog</>
                ) : (
